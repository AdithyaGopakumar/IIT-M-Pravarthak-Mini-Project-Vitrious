...
class InventraState(TypedDict, total=False):
    ...
    Categories follow the problem statement requirement:
    input, evidence (investigation + sourcing), proposal, review,
    approval, execution, workflow control, audit.
    """
