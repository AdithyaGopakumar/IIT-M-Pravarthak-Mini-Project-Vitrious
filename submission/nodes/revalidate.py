...
sufficiency.  This replaces the stub in ``tools/execution.py``.
"""
...
def _revalidate(proposal: ReplenishmentProposal) -> RevalidationResult:
    ...
    This is the real implementation that the provided stub skips.
    """
    errors: list[str] = []
...
def revalidate_node(state: InventraState) -> dict:
