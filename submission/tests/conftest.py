"""Pytest configuration and fixtures for Vitrious.
...
TEST_DB_PATH = str(_project_root / "database" / "test_inventra.db")
...
def mock_agents(mocker):
    ...
    """
    from submission.contracts.agent_outputs import (
        InvestigationResult,
        SourcingResult,
        ReviewResult,
    )
    ...
    mocks = {
        "investigation": mocker.patch("submission.graph.investigation_agent_node"),
        "sourcing": mocker.patch("submission.graph.sourcing_agent_node"),
        "review": mocker.patch("submission.graph.review_agent_node"),
    }
