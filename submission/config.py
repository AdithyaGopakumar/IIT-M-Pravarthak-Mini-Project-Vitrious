...
# Load .env from project root (one level up from submission/)
...
LANGCHAIN_PROJECT = os.getenv("LANGCHAIN_PROJECT", "vitrious")

# ── Database ──
DATABASE_PATH = str(_project_root / os.getenv("DATABASE_PATH", "database/inventra.db"))
