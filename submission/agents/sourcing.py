...
from submission.contracts.agent_outputs import SourcingResult
...
SOURCING_PROMPT = """\
You are the Sourcing Agent in the Vitrious stockout resolution system.
...
def sourcing_agent_node(state: InventraState) -> dict:
